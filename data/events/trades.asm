...
; entries correspond to TRADE_FOR_* constants
	...
	db GYARADOS,   LAPRAS,  TRADE_DIALOGSET_HAPPY,        "TESSI@@@@@@"
	...
	db PERRSERKER,    AERODACTYL,     TRADE_DIALOGSET_CASUAL,    "DAVIS@@@@@@"
	db MEOWTH,    PERRSERKER,  TRADE_DIALOGSET_HAPPY,     "PERRSERKER@"
	db PERRSERKER,    PERRSERKER,   TRADE_DIALOGSET_HAPPY,   "CHEETO@@@@@"
